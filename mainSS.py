...
#            print(input_data.size(), target_data.size())
            ...
            loss_train = certerion(target_data, output_data)
            loss_train.backward()
            optimizer.step()
...
if __name__ == '__main__':
    ...
    '''
    Seq2Seq_NINO_0116120842, Seq2Seq_NINO_0116143337, Seq2Seq_NINO_0116150807,  Seq2Seq_NINO_0120194221, Seq2Seq_NINO_0120212114.pth
    '''
    #m_path = 'checkpoints/Seq2Seq_NINO_0116150807.pth' 
    m_path = None
