...
#            print(input_data.size(), target_data.size())
            output_data, ifft_i, ifft_t = model(input_data, target_data)
...
if __name__ == '__main__':
    ...
    '''
    Recurrent__NINO_0118204453, Recurrent__NINO_0119194330
    '''
    m_path = 'checkpoints/Recurrent_NINO_0206233809.pth' 
#    m_path = None
