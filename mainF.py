...
def LetsGo(kwargs, fun):
    ...
    print('path : ',path) if path else print('loaded path : ',path)
...
if __name__ == '__main__':
    ...
    '''
    multiF_NINO_0120135421, multiF_NINO_0120162340, multiF_NINO_0120185345
    '''
    m_path = 'checkpoints/multiF_NINO_0120185345.pth' 
#    m_path = None
